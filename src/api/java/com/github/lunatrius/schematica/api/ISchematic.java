...
public interface ISchematic {
    ...
    /**
     * If schematic doesn't exist in the world, but has pregenerated blockstates to simulate it.
     * Returns the desirable blockstate.
     * 
     * @param pos
     * @return
     */
    IBlockState getRequiredBlockState(BlockPos pos, World world);
