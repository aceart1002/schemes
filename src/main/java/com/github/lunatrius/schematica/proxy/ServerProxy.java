...
public class ServerProxy extends CommonProxy {
    ...
    @Override
    public boolean loadSchematicFromFile(final EntityPlayer player, final File directory, 
	...
	@Override
	public boolean loadSchematic(EntityPlayer player, ISchematic schematic) {
