...
public class ConfigurationHandler {
    ...
    public static final File SCHEMATIC_DIRECTORY_DEFAULT = new File(Schemes.proxy.getDataDirectory(), SCHEMATIC_DIRECTORY_STR);
    ...
    private static File getSchematicDirectoryFile(String path) {
        if (path.startsWith(".")) {
            return Schemes.proxy.getDirectory(path);
        }
    ...
    private static void normalizeSchematicPath() {
        try {
            ...
            final String dataPath = Schemes.proxy.getDataDirectory().getAbsolutePath();
