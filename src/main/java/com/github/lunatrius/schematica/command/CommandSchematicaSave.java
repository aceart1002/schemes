...
public class CommandSchematicaSave extends CommandSchematicaBase {
    ...
    public void execute(final MinecraftServer server, final ICommandSender sender, final String[] args) throws CommandException {
        ...
        if (Schemes.proxy.isPlayerQuotaExceeded(player)) {
        ...
        final File schematicDirectory = Schemes.proxy.getPlayerSchematicDirectory(player, true);
        ...
        try {
            Schemes.proxy.saveSchematic(player, schematicDirectory, filename, player.getEntityWorld(), format, from, to);
